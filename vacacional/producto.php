...
<div class="img"><img loading='lazy' data-src="<?=$descar->field_image ? $urlGlobal . $descar->field_image : 'img/noimg.png'?>" alt='bogota' class='zone_img lazyload' src='https://picsum.photos/20/20'></div><span class="name uppercase"><?=$descar->title?></span></a>
    ...
    <section class="banco-imagenes-grid">
        ...
        <article style="background-image:url(/drpl/sites/default/files/2022-12/169_Ricardo_ygda6m.jpg);"><a href="<?=isset($prodTax->field_link_pla) ? $prodTax->field_link_pla : '/es/plan-bogota/'?>"><h4><img src="/vacacional/images/logo_pb-icon.svg" alt="banco"> <?=$pi_bogota[18]?></h4></a></article>
    </section>
