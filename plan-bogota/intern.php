    ...
    <div class="container">
      ...
      <div class="all-info" id="moreInfo">
        ...
        <div class="description">
          ...
          <a href="/g/booklink/?url=<?=$company->field_pb_empresa_direccion?>&id=<?=$_GET["planid"]?>&price=<?=$plan->field_pd?>" class="btn btn-reserva ms900 uppercase"> <?=$pb->pb_experiencias[27]?></a>
        </div>
      </div>
    </div>
